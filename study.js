        ...
        <div class="topic-menu">
            ...
            <div class="topic-category">
                ...
                <div class="topic-buttons">
                    ...
                    <button class="topic-btn" onclick="showTopic('html-tags')">
                        🌐 Tags Essenciais
                    </button>
                </div>
            </div>
            ...
            <div class="topic-category">
                ...
                <div class="topic-buttons">
                    ...
                    <button class="topic-btn" onclick="showTopic('css-cores-fundos')">
                        🎨 Cores e Fundos
                    </button>
                </div>
            </div>
            ...
            <div class="topic-category">
                ...
                <div class="topic-buttons">
                    ...
                    <button class="topic-btn" onclick="showTopic('javascript-avancado-es6')">
                        🚀 Recursos ES6+
                    </button>
            ...
            <div class="topic-category">
                ...
                <div class="topic-buttons">
                    ...
                    <button class="topic-btn" onclick="showTopic('git-comandos-completo')">
                        🛠️ Git Completo
                    </button>
                    <button class="topic-btn" onclick="showTopic('licencas-software')">
                        📜 Licenças
                    </button>
                </div>
            </div>
